    ...
    <div className="bg-[#F7F6F2] min-h-screen">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle, #2C392A 1.5px, transparent 1.5px)',
        ...
        >
          ...
          <p className="text-[16px] sm:text-[18px] font-black text-[#7DAA8F] mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-8 sm:gap-14 mb-12 sm:mb-16">
          {[
            ...
            <div key={stat.label} className="text-center">
              <p className="text-[2rem] sm:text-[2.5rem] font-black text-[#2C392A] leading-none">{stat.value}</p>
              <p className="text-[11px] font-bold text-[#5F6D59] mt-1 uppercase tracking-[0.15em]">{stat.label}</p>
            </div>
          ))}
        </div>
          ...
          {galleryImages.map((img, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px]
                ...
                transition-shadow duration-300 bg-[#EAD7B7]/20">
                <img
                  src={img.image}
                  alt={img.title}
                  loading="lazy"
                ...
                />
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-[#2C392A]/0 group-hover:bg-[#2C392A]/40
                ...
                {idx === 0 && (
                  <div className="absolute top-3 left-3 bg-[#2C392A] text-white

...
export const galleryImages: GalleryImage[] = [
  {
    id: 1,
    title: 'Our Store',
    description: 'Tirupathi Balaji Herbal Store — serving Chennai since 1945',
  ...
  },
  {
    ...
    description: 'Curated selection of authentic Siddha herbal products',
  ...
  },
  {
    ...
    description: 'Rooted in Siddha tradition passed down through generations',
